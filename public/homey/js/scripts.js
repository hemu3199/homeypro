...
$('.listing-carousel3').slick({
    ...
    sbp.on("click", function () {
        $(this).closest(".carousel-wrap1").find('.carousel1').slick('slickPrev');
    });
    sbn.on("click", function () {
        $(this).closest(".carousel-wrap1").find('.carousel1').slick('slickNext');
    });
    ...
    $("#subscribe").ajaxChimp({
        language: "eng",
        url: "https://homeypro.us14.list-manage.com/subscribe/post?u=fa8ac7976991bb91c26c37a26&amp;id=e05b578aaa"
    });
...
//         $('.modal1 , .reg-overlay1').fadeOut(200);
//         $("html, body").removeClass("hid-body");
//         $(".modal1_main").removeClass("vis_mr1");
//     };
//     $('.modal1-open').on("click", function (e) {
//         e.preventDefault();
//         $('.modal1 , .reg-overlay1').fadeIn(200);
//         $(".modal1_main").addClass("vis_mr1");
//         $("html, body").addClass("hid-body");
//     });
...
//     $('.close-reg , .reg-overlay1').on("click", function () {
//         modal1.hide();
//     });
...
// <div class="reg-overlay1" style="display: none;"></div>

// <!-- Your page content goes here -->

// <!-- JavaScript code to open the modal on page refresh -->
// <script>
    // var modal1 = {};
    // modal1.hide = function () {
    //     $('.modal1, .reg-overlay1').fadeOut(200);
    ...
    //     // Call the openModal function to open the modal on page load
    //     openModal();
    ...
    //     // Open the modal if it hasn't been opened before
    //     openModal();
    ...
    // // Check if the user has not signed in and modal has not been shown in the session
    // if (!isUserSignedIn && !sessionStorage.getItem('modalShown')) {
    //     // Open the modal if the user has not signed in and modal has not been shown
    //     openModal();

    //     // Set a flag in sessionStorage to indicate that the modal has been shown in this session
...
// $(document).ready(function() {
//     let roomIndex = 1;
//     let housePlanIndex = 1;

//     // Handle adding new rooms
//     $('.add-room-item').click(function(e) {
//         e.preventDefault();
//         const newRoom = $('.add_room-item:first').clone();
//         newRoom.find('input').val(''); // Clear input values
//         newRoom.find('textarea').val(''); // Clear textarea values
//         newRoom.find('.photoUpload-files').empty(); // Clear uploaded files display

//         newRoom.find('input, textarea').each(function() {
//             const inputName = $(this).attr('name').replace('[0]', '[' + roomIndex + ']');
//             $(this).attr('name', inputName);
//         });

//         $('.add_room-item-wrap').append(newRoom);
//         roomIndex++;
//     });

//     // Handle adding new house plans
//     $('.add-plan-item').click(function(e) {
//         e.preventDefault();
//         const newPlan = $('.add_house-plan:first').clone();
//         newPlan.find('input').val(''); // Clear input values
//         newPlan.find('textarea').val(''); // Clear textarea values
//         newPlan.find('.photoUpload-files').empty(); // Clear uploaded files display

//         newPlan.find('input, textarea').each(function() {
//             const inputName = $(this).attr('name').replace('[0]', '[' + housePlanIndex + ']');
//             $(this).attr('name', inputName);
//         });

//         $('.add_house-plan-wrap').append(newPlan);
//         housePlanIndex++;
//     });

//     // Handle removing items
//     $('.add_room-item-wrap, .add_house-plan-wrap').on('click', '.remove-item', function() {
//         $(this).closest('.add_room-item, .add_house-plan').remove();
//     });

//     // Handle file upload input change
//     $('.fuzone input').on('change', function() {
//         const pufzone = $(this).parents(".fuzone").find('.photoUpload-files');
//         pufzone.empty();
...
//         const newPlan = $('.add_house-plan:first').clone();
//         newPlan.find('input').val(''); // Clear input values
//         newPlan.find('input').each(function() {
//             const inputName = $(this).attr('name').replace('[0]', '[' + housePlanIndex + ']');
//             $(this).attr('name', inputName);
//         });
