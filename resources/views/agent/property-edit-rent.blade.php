...
@endif
  @if ($errors->any())
                        ...
                        <!-- dashboard-title end -->    
                        <form method="post" action="{{ route('agent.propertyeditfn',$property_details->property_id) }}" id="form" enctype="multipart/form-data">   
                             @csrf
                                                ...
                                                <div class="listsearch-input-item fl-wrap">
                                                        ...
                                                        @foreach($mainimages as $key => $image)
                                                            <div class="col-sm-1" style="padding: 10px;height: 130px; margin: 10px;">
                                                                ...
                                                                <div>{{$image->ID}}</div>
                                                               <a href="{{route('agent.deleteimages',$image->ID)}}"> Remove</a>
                                                                 </div>
                                                            </div>
                                                        @endforeach
                                ...
                                <div class="custom-form rooms">
                                    <!-- <div id="dynamicAddRemove_Education"> -->
                                        ...
                                        <div class="add_room-item fl-wrap" >
                                            <a href="{{route('agent.deleteroomsection',$room[$i]['room_id'])}}" class="remove-rp tolt" data-microtip-position="left"  data-tooltip="Remove Room"><i class="fal fa-times-circle"></i></a>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                ...
                                                <div class="listsearch-input-item fl-wrap">
                                                        ...
                                                        @foreach($roomimages as $key => $image)
                                                            <div class="col-sm-1" style="padding: 10px;height: 130px; margin: 10px;">
                                                                ...
                                                                <img src="{{ url('/uploads/properties/' . $image->image_name) }}" style="height:58px;">
                                                                <div>{{$image->id}}</div>
                                                             <a href="{{route('agent.deleteroomimages',$image->id)}}"> Remove</a>
                                                                 </div>
                                                            </div>
                                                        @endforeach
                                ...
                                <!-- <div id="" > -->
                                    <div class="custom-form houseplans">
                                        ...
                                        <div class="add_room-item fl-wrap" >
                                            ...
                                            <a href="{{route('agent.deletehousesection',$houseplans[$i]['id'])}}" class="remove-rp tolt" data-microtip-position="left"  data-tooltip="Remove"><i class="fal fa-times-circle"></i></a>
                                            <div class="row">
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                ...
                                                <div class="listsearch-input-item fl-wrap">
                                                            ...
                                                            <div class="col-sm-1" style="padding: 10px;height: 130px; margin: 10px;">
                                                                ...
                                                                <a href="{{route('agent.deletehouseimages',$houseplans[$i]['id'])}}"> Remove</a>
                                                                 </div>
                                                            </div>
