            ...
            <div class="card mb-3">
              <div class="card-body">
                <div class="d-flex flex-column">
                  <img src="{{asset('users/img/property/B2.png')}}" alt="" class="img-fluid rounded-2">
            ...
            <div class="card mb-3">
              <div class="card-body">
                <div class="text-center">
                  <img src="{{asset('users/img/d.jpg')}}" alt="" class="rounded-circle">
                  <div class="media-body mt-4 text-center">
                    <h5 class="fw-bold mb-1">{{DB::table('agents')->where(['id' => $projectviewdetails->agent_id])->pluck('name')->first();}}</h5>
                    <div class="text-muted mb-1"><i class="fa fa-phone"></i> </div>
                    <div class="text-muted mb-3"><i class="fa fa-envelope"></i> {{DB::table('agents')->where(['id' => $projectviewdetails->agent_id])->pluck('email')->first();}}</div>
