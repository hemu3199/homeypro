  ...
  @section  ("content")
      ...
      <!-- start: page body -->
      <form method="post" action="project-add" id="form" enctype="multipart/form-data">
        @csrf
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row g-3">
                    ...
                    <div class="col-md-6 col-sm-12">
                      <div class="form-floating">
                        <input type="text" class="form-control" name="project_location" placeholder="Project Location">
                        <label>Project Location <b style="color: red;">*</b> :</label>
                      </div>
                    </div>
                    <div class="col-md-12 col-sm-12">
                      <div class="form-floating">
                        <textarea class="form-control" rows="4" name="project_description"  placeholder="Description"></textarea>
                   ...
                   <div class="col-12">
                      <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-3">
                        <div class="col">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="avg_price" placeholder="Price / Rent">
                            <label>Avg Price / Rent: <b style="color: red;">*</b></label>
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="portion_sizes" placeholder="BedroomsSquare ft">
                            <label>Portion Sizes </label>
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="project_area" placeholder="Square ft">
                            <label>Project Area : <b style="color: red;">*</b></label>
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="configurations" placeholder="Car Parking">
                            <label>Configurations</label>
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="launch_date" placeholder="Year Built">
                            <label>Launch Date: <b style="color: red;">*</b></label>
                          </div>
                        </div>
                      </div>
                      <div class="form-floating mt-3">
                        <textarea class="form-control" rows="4" name="project_address" placeholder="Property Address"></textarea>
    ...
    $("#form").submit(function(){
              ...
              axios.post("{{route('agent.property-rent-store')}}",new FormData($("#form")[0])).then(response=>{
                  var data = response.data;
                  if(data.success) notify(null,'Property added successfully','top right','success',true,1000);
                  else{
                      for (var a in data['error']['message']) {
                          
                          if(a == 'description') notify('#form textarea[name='+a+']',data['error']['message'][a][0], 'botton left');
                          else notify('#form input[name='+a+']',data['error']['message'][a][0], 'botton left');
                      }
                  }
              }).catch(error=>{
                  console.log(error);
