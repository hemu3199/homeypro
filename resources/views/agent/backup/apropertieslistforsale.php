...
<head>
  ...
  <link rel="icon" href="https://www.wrraptheme.com/templates/luno/assets/img/favicon.ico" type="image/x-icon"> <!-- Favicon-->
  <title>:: HOMEY :: Real-Estate Property List</title>
...
<body class="layout-1" data-luno="theme-red">
  ...
  <div class="sidebar p-2 py-md-3 @@cardClass">
    <div class="container-fluid">
      ...
      <div class="title-text d-flex align-items-center mb-4 mt-1">
        <h4 class="sidebar-title mb-0 flex-grow-1"><span class="sm-txt" style="font-weight: bold;">HOMEY</span></h4>
      ...
      <div class="create-new py-3 mb-2">
        <div class="d-flex">
          <select class="form-select rounded-pill me-1">
            <option selected>Type Of the Property</option>
      ...
      <div class="main-menu flex-grow-1">
        <ul class="menu-list">
          ...
          <li class="collapsed">
            <a class="m-link active " data-bs-toggle="collapse" data-bs-target="#menu_property" href="#">
               <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293l6-6zm5-.793V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z" />
                <path class="fill-secondary" fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z" />
              </svg>
              <span class="ms-2">Properties For Sale</span>
              <span class="arrow fa fa-angle-right ms-auto text-end"></span>
            </a>
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse show " id="menu_property">
              <li><a class="ms-link" href="property-add.html">Add Property</a></li>
              <li><a class="ms-link active" href="property-list.html">Property List</a></li>
          ...
          <li class="collapsed">
            <a class="m-link " data-bs-toggle="collapse" data-bs-target="#menu_property" href="#">
              ...
              <span class="ms-2">Properties For Rent</span>
              <span class="arrow fa fa-angle-right ms-auto text-end"></span>
            </a>
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse" id="menu_property">
              <li><a class="ms-link " href="property-add-Rent.html">Add Property</a></li>
              <li><a class="ms-link" href="property-list-Rent.html">Property List</a></li>
              <li><a class="ms-link" href="property-grid-Rent.html">Property Grid</a></li>
              <li><a class="ms-link" href="property-detail-Rent.html">Property Detail</a></li>
            </ul>
          </li>
          <li class="collapsed">
  ...
  <div class="wrapper">
            ...
            <a href="https://www.wrraptheme.com/templates/luno/index.html" class="brand-icon d-flex align-items-center mx-2 mx-sm-3 text-primary">
              <!--<svg height="22" viewBox="0 0 67 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path class="fill-muted" d="M66.0301 10.0497C66.0301 11.433 65.8551 12.6913 65.5051 13.8247C65.1551 14.9413 64.6301 15.908 63.9301 16.7247C63.2467 17.5413 62.3884 18.1663 61.3551 18.5997C60.3384 19.033 59.1551 19.2497 57.8051 19.2497C56.4051 19.2497 55.1884 19.033 54.1551 18.5997C53.1217 18.1497 52.2634 17.5247 51.5801 16.7247C50.8967 15.908 50.3884 14.933 50.0551 13.7997C49.7217 12.6663 49.5551 11.408 49.5551 10.0247C49.5551 8.19135 49.8551 6.59135 50.4551 5.22468C51.0551 3.85801 51.9634 2.79135 53.1801 2.02468C54.4134 1.25801 55.9634 0.87468 57.8301 0.87468C59.6134 0.87468 61.1134 1.25801 62.3301 2.02468C63.5467 2.77468 64.4634 3.84135 65.0801 5.22468C65.7134 6.59135 66.0301 8.19968 66.0301 10.0497ZM51.9301 10.0497C51.9301 11.5497 52.1384 12.8413 52.5551 13.9247C52.9717 15.008 53.6134 15.8413 54.4801 16.4247C55.3634 17.008 56.4717 17.2997 57.8051 17.2997C59.1551 17.2997 60.2551 17.008 61.1051 16.4247C61.9717 15.8413 62.6134 15.008 63.0301 13.9247C63.4467 12.8413 63.6551 11.5497 63.6551 10.0497C63.6551 7.79968 63.1884 6.04135 62.2551 4.77468C61.3217 3.49135 59.8467 2.84968 57.8301 2.84968C56.4801 2.84968 55.3634 3.14135 54.4801 3.72468C53.6134 4.29135 52.9717 5.11635 52.5551 6.19968C52.1384 7.26635 51.9301 8.54968 51.9301 10.0497Z" />
                   ...
                   <img src="E:\all india\VUSOh90T6D7k4XBKe55KHo5MFUoVDqj1e63PCyo5.png" alt="Forge" height="30" width="50">
            </a>
          </div>
          <!-- start: search area -->
            ...
            <li>
              <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button" data-bs-toggle="dropdown">
                  <img class="avatar img-thumbnail rounded-circle shadow" src="E:\all india\th (43).jpg" alt="">
                </a>
                <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                  <div class="card border-0 w240">
                    <div class="card-body border-bottom d-flex">
                      <img class="avatar rounded-circle" src="E:\all india\th (43).jpg" alt="">
                      <div class="flex-fill ms-3">
                        <h6 class="card-title mb-0">Ramu</h6>
                        <span class="text-muted">Ramu@forge.com</span>
                      </div>
                    </div>
    ...
    <div class="page-toolbar px-xl-4 px-sm-2 px-0 py-3">
      <div class="container-fluid">
        ...
        <div class="row align-items-center">
          <div class="col-auto">
            <h1 class="fs-5 color-900 mt-1 mb-0">Welcome back, Ramu!</h1>
            <small class="text-muted">You have 5 new messages and 1 new notifications.</small>
          </div>
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    <div class="input-group">
                      <span class="input-group-text" id="propertySearch"><i class="fa fa-search"></i></span>
                      <input type="text" class="form-control" placeholder="Search..." aria-label="property-search" aria-describedby="propertySearch">
                    </div>
                  </div>
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                    <input type="text" class="form-control" id="SqFt" placeholder="Sq Ft">
                  </div>
                </div>
              </div>
              <div class="card-body border-top">
                <table id="PropertyList" class="table dataTable mb-0">
                  <thead>
                    <tr>
                      <th class="border-top-0">Property Name</th>
                      <th class="border-top-0">Beds</th>
                      <th class="border-top-0">Baths</th>
                      <th class="border-top-0">Sq Ft</th>
                  ...
                  <tbody>
                      ...
                      <td class="d-flex align-items-center">
                        <a href="property-detail.html" class="d-block w60"><img class="img-fluid rounded" src="../assets/img/real-estate/6.jpg" alt="property img"></a>
                        <div class="ms-3">
                          <strong>Green Villas</strong>
                          <div class="font-13 text-muted hidden-md"><i class="fa fa-map-pin"></i> 2-120 , Kukatpally , HYD 500072</div>
                        </div>
                      </td>
                      <td>3</td>
                      <td>2</td>
                      ...
                      <td>
                        <span>Apartment</span>
                        <div class="text-muted">Year built: 2011</div>
                      </td>
                      <td>
                        <img src="E:\all india\th (43).jpg" class="rounded-circle avatar" alt="">
                        <span>Abhi</span>
                      </td>
                      <td><strong class="text-info">$13,000</strong></td>
                      <td><span class="badge bg-danger">For Sale</span></td>
                    </tr> <tr>
                      <td class="d-flex align-items-center">
                        <a href="property-detail.html" class="d-block w60"><img class="img-fluid rounded" src="../assets/img/real-estate/6.jpg" alt="property img"></a>
                        <div class="ms-3">
                    ...
                    <tr>
                      <td class="d-flex align-items-center">
                        <a href="property-detail.html" class="d-block w60"><img class="img-fluid rounded" src="../assets/img/real-estate/7.jpg" alt="property img"></a>
                        <div class="ms-3">
                          <strong>House on the beverly hills</strong>
                      ...
                      <td>
                        <span>Bungalow</span>
                        <div class="text-muted">Year built: 2020</div>
                      </td>
                      <td>
                        <img src="../assets/img/xs/avatar1.jpg" class="rounded-circle avatar" alt="">
                        <span>Orlando</span>
                      </td>
                      <td><strong class="text-info">$29,000</strong></td>
                      <td><span class="badge bg-danger">For Sale</span></td>
                    </tr>
                    <tr>
                      <td class="d-flex align-items-center">
                        <a href="property-detail.html" class="d-block w60"><img class="img-fluid rounded" src="../assets/img/real-estate/8.jpg" alt="property img"></a>
                        <div class="ms-3">
                          <strong>House on the Hollywood</strong>
                          <div class="font-13 text-muted hidden-md"><i class="fa fa-map-pin"></i> 123 6th St. Melbourne, FL 32904</div>
                        </div>
                      </td>
                      <td>4</td>
                      <td>4</td>
                      ...
                      <td>
                        <span>Bungalow</span>
                        <div class="text-muted">Year built: 2017</div>
                      </td>
                      <td>
                        <img src="../assets/img/xs/avatar1.jpg" class="rounded-circle avatar" alt="">
                        <span>Orlando</span>
                      </td>
                      <td><strong class="text-info">$19,500</strong></td>
                      <td><span class="badge bg-danger">For Sale</span></td>
                    </tr>
                  </tbody>
                </table>
    ...
    <footer class="page-footer px-xl-4 px-sm-2 px-0 py-3">
      <div class="container-fluid d-flex flex-wrap justify-content-between align-items-center">
        <p class="col-md-4 mb-0 text-muted">© 2023 <a href="https://www.thememakker.com/" target="_blank" title="ThemeMakker Infotech LLP">Forge</a>, All Rights Reserved.</p>
  ...
  <script>
    // project data table
    $('#PropertyList').addClass('nowrap').dataTable({
      responsive: true,
      pageLength: 5,
      lengthMenu: [
        [5, 10, 20, -1],
