...
if(isset($_POST['submit']))
{
  ...
  if ($password==$cpassword)
   {
    $query="INSERT INTO agent_basic_information(fname,lname,dateofbirth,gender,speciality,mobile,a_email,url,file,description,username,phoneno,password,cpassword,face,twitter,google,linkedin)values('$fname','$lname','$dob','$gender','$speciality','$mobile','$email','$url','$file','$description','$username','$phoneno','$password','$cpassword','$face','$twitter','$google','$linkedin')";
...
<head>
  ...
  <title>:: Forge :: HOMEY Add Agent</title>
    ...
    <div class="container-fluid">
      ...
      <div class="main-menu flex-grow-1">
        <ul class="menu-list">
          ...
          <li class="collapsed">
            <a class="m-link active" data-bs-toggle="collapse" data-bs-target="#menu_agents" href="#">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
            ...
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse show" id="menu_agents">
              <li><a class="ms-link" href="agent-dashboard.html">Dashboard</a></li>
              <li><a class="ms-link active" href="agent-add.html">Add New</a></li>
            ...
            <a href="https://www.wrraptheme.com/templates/luno/index.html" class="brand-icon d-flex align-items-center mx-2 mx-sm-3 text-primary">
              <!--<svg height="22" viewBox="0 0 67 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path class="fill-muted" d="M66.0301 10.0497C66.0301 11.433 65.8551 12.6913 65.5051 13.8247C65.1551 14.9413 64.6301 15.908 63.9301 16.7247C63.2467 17.5413 62.3884 18.1663 61.3551 18.5997C60.3384 19.033 59.1551 19.2497 57.8051 19.2497C56.4051 19.2497 55.1884 19.033 54.1551 18.5997C53.1217 18.1497 52.2634 17.5247 51.5801 16.7247C50.8967 15.908 50.3884 14.933 50.0551 13.7997C49.7217 12.6663 49.5551 11.408 49.5551 10.0247C49.5551 8.19135 49.8551 6.59135 50.4551 5.22468C51.0551 3.85801 51.9634 2.79135 53.1801 2.02468C54.4134 1.25801 55.9634 0.87468 57.8301 0.87468C59.6134 0.87468 61.1134 1.25801 62.3301 2.02468C63.5467 2.77468 64.4634 3.84135 65.0801 5.22468C65.7134 6.59135 66.0301 8.19968 66.0301 10.0497ZM51.9301 10.0497C51.9301 11.5497 52.1384 12.8413 52.5551 13.9247C52.9717 15.008 53.6134 15.8413 54.4801 16.4247C55.3634 17.008 56.4717 17.2997 57.8051 17.2997C59.1551 17.2997 60.2551 17.008 61.1051 16.4247C61.9717 15.8413 62.6134 15.008 63.0301 13.9247C63.4467 12.8413 63.6551 11.5497 63.6551 10.0497C63.6551 7.79968 63.1884 6.04135 62.2551 4.77468C61.3217 3.49135 59.8467 2.84968 57.8301 2.84968C56.4801 2.84968 55.3634 3.14135 54.4801 3.72468C53.6134 4.29135 52.9717 5.11635 52.5551 6.19968C52.1384 7.26635 51.9301 8.54968 51.9301 10.0497Z" />
                   ...
                   <img src="../assets/img/FORGE.png" alt="Forge" height="30" width="50">
            </a>
          </div>
          <!-- start: search area -->
            ...
            <li>
              <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button" data-bs-toggle="dropdown">
                  <img class="avatar img-thumbnail rounded-circle shadow" src="../assets/img/th (43).jpg" alt="">
                </a>
      ...
      <div class="container-fluid">
        <div class="row g-3">
                ...
                <div class="row g-3">
                  <div class="col-sm-6">
                    <div class="form-floating">
                      ...
                      <label>First Name <sup class="text-danger fs-6" >*</sup></label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-floating">
                      <input type="text" class="form-control form-control-lg" name="lname" required placeholder="Enter here" name="lname">
                      <label>Last Name<sup class="text-danger fs-6" >*</sup></label>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-floating">
                  ...
                  <div class="col-sm-6">
                    <div class="form-floating">
                      ...
                      <label>Your Email<sup class="text-danger fs-6" >*</sup></label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-floating">
                      <input type="url" class="form-control form-control-lg" name="url" placeholder="Enter here">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row g-3">
                  <div class="col-sm-6">
                    <div class="form-floating">
                      <input type="text" class="form-control form-control-lg" name="username" placeholder="Enter here">
                      <label>User Name <sup class="text-danger fs-6" >*</sup></label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-floating">
                  ...
                  <div class="col-sm-6">
                    <div class="form-floating">
                      ...
                      <label>Password <sup class="text-danger fs-6" >*</sup></label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-floating">
                      <input type="password" class="form-control form-control-lg" name="cpassword" placeholder="Enter here">
                      <label>Confirm Password <sup class="text-danger fs-6" >*</sup></label>
                    </div>
                  </div>
                 <!-- <div class="col-sm-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row g-3">
                  ...
                  <div class="col-sm-6">
                    <div class="form-floating">
                      <input type="number" class="form-control form-control-lg" name="twitter" placeholder="Enter here">
                      <label>Twitter</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-floating">
                      <input type="password" class="form-control form-control-lg" name="google" placeholder="Enter here">
                      <label>Google</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-floating">
                      <input type="password" class="form-control form-control-lg" name="linkedin" placeholder="Enter here">
          ...
          <div class="col-sm-12 ">
            ...
            <button type="" class="btn btn-default" name="">Cancel</button>
          </div>
        </div> <!-- .row end -->
      </div>
    </div>
