...
<head>
  ...
  <title>:: HOMEY :: Real-Estate Account Settings</title>
  ...
  <div class="sidebar p-2 py-md-3 @@cardClass">
    <div class="container-fluid">
      ...
      <div class="title-text d-flex align-items-center mb-4 mt-1">
        <h4 class="sidebar-title mb-0 flex-grow-1"><span class="sm-txt">HOMEY</span></h4>
        ...
        <ul class="menu-list">
          ...
          <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="menu_agents">
              <li><a class="ms-link" href="index.php">Dashboard</a></li>
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-5 col-sm-4">
                        <input type="text" class="form-control form-control-lg"  value="<?php echo $_SESSION['fname']; ?>">
                      </div>
                      <div class="col-md-4 col-sm-4">
                        <input type="text" class="form-control form-control-lg" value="<?php echo $_SESSION['lname']; ?>">
                      </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-9 col-sm-8">
                        <input type="text" class="form-control form-control-lg" value="<?php echo $_SESSION['mobile']; ?>">
                      </div>
                    </div>
                    <div class="row mb-3">
