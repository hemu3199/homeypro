...
if(isset($_POST['submit']))
{
  ...
  $aid=$_SESSION['id'];
$chk="";  
foreach($general as $chk1)  
   {  
      $chk .= $chk1.",";  
   } 
  $query="INSERT INTO properties(pname,plocation,pdescription,property,price,bedsqft,sqft,carparking,year,propertyadd,kitchen,livingroom,masterbedroom,bedroom2,otherroom,general,file,aid)VALUES('$pname','$plocation','$pdescription','$property','$price','$bedsqft','$carparking','$year','$propertyadd','$diningroom','$kitchen','$livingroom','$masterbedroom','$bedroom2','$other','$chk','$file','$aid')";
...
<head>
  ...
  <title>:: LUNO :: Real-Estate Add Property</title>
        ...
        <ul class="menu-list">
          ...
          <li class="collapsed">
            ...
            <ul class="sub-menu collapse show" id="menu_property">
              <li><a class="ms-link active" href="property-add.html">Add Property</a></li>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row g-3">
                  ...
                  <div class="col-md-6 col-sm-12">
                    <div class="form-floating">
                      <input type="text" class="form-control" name="plocation" placeholder="Property Location">
                      <label>Property Location</label>
                    </div>
                  </div>
                  <div class="col-md-12 col-sm-12">
                    <div class="form-floating">
                      <textarea class="form-control" rows="4" name="pdescription"  placeholder="Description"></textarea>
                  ...
                  <div class="col-12">
                   ...
                   <div class="col-12">
                    <div class="d-flex">
                      <div class="form-check mb-0">
                        <label for="cars"><h5>Property Type:</h5></label>
                      </div>
                      <div class="form-check mb-0 ms-3">
                        <select name="cars" id="cars">
  <option value="volvo">Apartment</option>
  <option value="saab">Farm house</option>
  <option value="mercedes">Villa</option>
  <option value="audi">Corporate Office</option>
   <option value="audi">Shopping Mall</option>
                ...
                <div class="row g-3">
                  <div class="col-12">
                    <h6 class="mt-5 mb-1">Dimensions</h6>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-floating">
