...
<head>
  ...
  <title>:: HOMEY :: Real-Estate Project</title>
  ...
  <div class="sidebar p-2 py-md-3 @@cardClass">
    <div class="container-fluid">
      ...
      <div class="title-text d-flex align-items-center mb-4 mt-1">
        <h4 class="sidebar-title mb-0 flex-grow-1"><span class="sm-txt">R</span><span>eal Estate</span></h4>
        <div class="dropdown morphing scale-left">
          ...
          <ul class="dropdown-menu shadow border-0 p-2 mt-2" data-bs-popper="none">
            ...
            <li><a class="dropdown-item" href="https://www.wrraptheme.com/templates/luno/landing/index.html" aria-current="page">Landing page</a></li>
            <li><a class="dropdown-item" href="https://www.wrraptheme.com/templates/luno/inventory/index.html">Inventory</a></li>
            <li><a class="dropdown-item" href="https://www.wrraptheme.com/templates/luno/ecommerce/index.html">eCommerce</a></li>
            <li><a class="dropdown-item" href="https://www.wrraptheme.com/templates/luno/hrms/index.html">HRMS</a></li>
            <li>
              <hr class="dropdown-divider">
            </li>
            <li><a class="dropdown-item" href="https://www.wrraptheme.com/templates/luno/account-invoices.html">Invoices List</a></li>
            <li><a class="dropdown-item" href="https://www.wrraptheme.com/templates/luno/account-create-invoices.html">Create Invoices</a></li>
          </ul>
        </div>
      </div>
      <!-- sidebar: Create new -->
        ...
        <ul class="menu-list">
          ...
          <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="menu_agents">
              <li><a class="ms-link" href="agent-dashboard.html">Dashboard</a></li>
              <li><a class="ms-link" href="agent-add.html">Add New</a></li>
              <li><a class="ms-link" href="agent-list.html">Agents List</a></li>
              <li><a class="ms-link" href="agent-profile.html">Profile</a></li>
              <li><a class="ms-link" href="agent-gallery.html">Gallery</a></li>
              <li><a class="ms-link" href="agent-activity.html">Activity</a></li>
            </ul>
          </li>
          <li>
            <a class="m-link" href="agencies.html">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293l6-6zm5-.793V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z" />
                <path class="fill-secondary" fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z" />
              </svg>
              <span class="ms-2">Agencies</span>
            </a>
          </li>
          <li class="collapsed">
            <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu_property" href="#">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
            ...
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse" id="menu_property">
              <li><a class="ms-link" href="property-add.html">Add Property</a></li>
              <li><a class="ms-link" href="property-list.html">Property List</a></li>
              <li><a class="ms-link" href="property-grid.html">Property Grid</a></li>
              <li><a class="ms-link" href="property-detail.html">Property Detail</a></li>
            </ul>
          </li>
          <li class="collapsed">
            <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu_types" href="#">
              ...
              <span class="ms-2">Types</span>
              <span class="arrow fa fa-angle-right ms-auto text-end"></span>
            </a>
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse" id="menu_types">
              <li><a class="ms-link" href="type-apartment.html">Apartment</a></li>
              <li><a class="ms-link" href="type-bungalows.html">Bungalows / Villa</a></li>
              <li><a class="ms-link" href="type-house.html">Farm House</a></li>
              <li><a class="ms-link" href="type-office.html">Corporate Office</a></li>
              <li><a class="ms-link" href="type-plot.html">Party Plot</a></li>
              <li><a class="ms-link" href="type-shop.html">Shopping Mall</a></li>
              <li><a class="ms-link" href="type-warehouse.html">WareHouse</a></li>
              <li><a class="ms-link" href="type-weekend-house.html">Weekend House</a></li>
            </ul>
          </li>
          <li>
            <a class="m-link" href="our-centres.html">
              ...
              <span class="ms-2">Construction Site</span>
            </a>
          </li>
        </ul>
        <ul class="menu-list">
          ...
          <li>
            <a class="m-link" href="https://www.wrraptheme.com/templates/luno/docs/doc-changelog.html">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
      ...
      <ul class="menu-list nav navbar-nav flex-row text-center menu-footer-link">
        ...
        <li class="nav-item flex-fill p-2">
          <a class="d-inline-block w-100 color-400" href="https://www.wrraptheme.com/templates/luno/auth-signin.html" title="sign-out">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
              ...
              <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                ...
                <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                  <div class="card border-0 w240">
                    ...
                    <a href="https://www.wrraptheme.com/templates/luno/auth-signin.html" class="btn bg-secondary text-light text-uppercase rounded-0">Sign out</a>
                  </div>
                </div>
              </div>
            </li>
      ...
      <div class="project-list d-flex flex-nowrap">
        <div class="order-1 custom_scroll">
          ...
          <ul class="nav nav-tabs menu-list list-unstyled mb-0 border-0" role="tablist">
            ...
            <li>
              <a href="#" data-bs-toggle="tooltip" data-placement="top" title="Clients name"><img class="avatar rounded-circle m-1 lift" src="../assets/img/xs/avatar1.jpg" alt=""></a>
              <a href="#" data-bs-toggle="tooltip" data-placement="top" title="Clients name"><img class="avatar rounded-circle m-1 lift" src="../assets/img/xs/avatar2.jpg" alt=""></a>
              <a href="#" data-bs-toggle="tooltip" data-placement="top" title="Clients name"><img class="avatar rounded-circle m-1 lift" src="../assets/img/xs/avatar3.jpg" alt=""></a>
              <a href="#" data-bs-toggle="tooltip" data-placement="top" title="Clients name"><img class="avatar rounded-circle m-1 lift" src="../assets/img/xs/avatar4.jpg" alt=""></a>
              <a href="#" data-bs-toggle="tooltip" data-placement="top" title="Clients name"><img class="avatar rounded-circle m-1 lift" src="../assets/img/xs/avatar5.jpg" alt=""></a>
            </li>
          </ul>
        </div>
                  ...
                  <div class="tab-pane fade show active" id="project_all" role="tabpanel">
                    ...
                    <div class="row g-3">
                      <div class="col">
                        <div class="card">
                          <div class="card-body">
                            <h5 class="mb-1"><a href="app-project-detail.html" class="color-600">School / University</a></h5>
                            ...
                            <div class="project-members mb-4">
                              ...
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar3.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Team Lead" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar1.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Designer" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar7.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Developer" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar9.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Developer" alt="friend"> </a>
                            </div>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="card-body">
                            <h5 class="mb-1"><a href="app-project-detail.html" class="color-600">LUNO job Portal</a></h5>
                            <p class="text-muted">CRM App application to University Admin..</p>
                            <ul class="list-inline d-flex my-4">
                              <li class="list-inline-item card py-2 px-xxl-3 px-xl-2 px-3">
                                <h6 class="mb-0">10</h6>
                            ...
                            <div class="project-members mb-4">
                              <label class="me-2">Team :</label>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar4.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Team Lead" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar2.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Designer" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar9.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Developer" alt="friend"> </a>
                            </div>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="card-body">
                            <h5 class="mb-1"><a href="app-project-detail.html" class="color-600">Shift CRM</a></h5>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="card-body">
                            <h5 class="mb-1"><a href="app-project-detail.html" class="color-600">WT.TH Health analytics</a></h5>
                            ...
                            <div class="project-members mb-4">
                              <label class="me-2">Team :</label>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar7.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Team Lead" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar8.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Developer" alt="friend"> </a>
                            </div>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="card-body">
                            <h5 class="mb-1"><a href="app-project-detail.html" class="color-600">TTM Banking</a></h5>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="card-body">
                            <h5 class="mb-1"><a href="app-project-detail.html" class="color-600">LUNO Hospital</a></h5>
                            ...
                            <div class="project-members mb-4">
                              ...
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar7.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Team Lead" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar2.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Designer" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar4.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Developer" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar10.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Developer" alt="friend"> </a>
                            </div>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="card-body">
                            <h5 class="mb-1"><a href="app-project-detail.html" class="color-600">SKO Cryptocurrency</a></h5>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="card-body">
                            <h5 class="mb-1"><a href="app-project-detail.html" class="color-600">ATKT Event Managment</a></h5>
                            ...
                            <div class="project-members mb-4">
                              <label class="me-2">Team :</label>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar1.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Team Lead" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar7.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Developer" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar2.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Developer" alt="friend"> </a>
                            </div>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="project-members mb-4">
                              <label class="me-2">Team :</label>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar8.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Team Lead" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar3.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Designer" alt="friend"> </a>
                              <a href="#" title=""><img class="avatar sm rounded-circle" src="../assets/img/xs/avatar1.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Developer" alt="friend"> </a>
                            </div>
                            <label class="small d-flex justify-content-between">0% <span class="text-custom">Done</span></label>
                            <div class="progress mt-1" style="height: 3px;">
                  ...
                  <div class="tab-pane fade" id="project_overdue" role="tabpanel">
                    ...
                    <div class="card">
                      <div class="card-body text-center p-5">
                        <img src="https://www.wrraptheme.com/templates/luno/assets/img/no-data.svg" class="w120" alt="No Data">
                        <div class="mt-4 mb-3">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="step4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <img class="img-fluid" src="https://www.wrraptheme.com/templates/luno/assets/img/project-team.svg" alt="" />
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="modal-dialog modal-dialog-vertical right-side modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="px-xl-4 modal-body custom_scroll">
          ...
          <div class="card fieldset border setting-mode mb-4">
            ...
            <div class="c_radio d-flex text-center">
              <label class="m-1 theme-switch" for="theme-switch">
                ...
                <span class="card p-2">
                  <img class="img-fluid" src="https://www.wrraptheme.com/templates/luno/assets/img/dark-version.svg" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1 theme-dark" for="theme-dark">
                <input type="checkbox" id="theme-dark" />
                <span class="card p-2">
                  <img class="img-fluid" src="https://www.wrraptheme.com/templates/luno/assets/img/dark-theme.svg" alt="Theme Dark Mode" />
                </span>
              </label>
              <label class="m-1 theme-high-contrast" for="theme-high-contrast">
                <input type="checkbox" id="theme-high-contrast" />
                <span class="card p-2">
                  <img class="img-fluid" src="https://www.wrraptheme.com/templates/luno/assets/img/high-version.svg" alt="High Contrast" />
                </span>
              </label>
              <label class="m-1 theme-rtl" for="theme-rtl">
                <input type="checkbox" id="theme-rtl" />
                <span class="card p-2">
                  <img class="img-fluid" src="https://www.wrraptheme.com/templates/luno/assets/img/rtl-version.svg" alt="RTL Mode!" />
                </span>
              </label>
            </div>
          </div>
          ...
          <div class="card fieldset border setting-font">
            ...
            <div class="c_radio d-flex text-center font_setting">
              <label class="m-1" for="font-opensans">
                ...
                <span class="card p-2">
                  <img class="img-fluid" src="https://www.wrraptheme.com/templates/luno/assets/img/font-opensans.svg" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-quicksand">
                <input type="radio" name="font" id="font-quicksand" value="font-quicksand" />
                <span class="card p-2">
                  <img class="img-fluid" src="https://www.wrraptheme.com/templates/luno/assets/img/font-quicksand.svg" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-nunito">
                <input type="radio" name="font" id="font-nunito" value="font-nunito" checked="" />
                <span class="card p-2">
                  <img class="img-fluid" src="https://www.wrraptheme.com/templates/luno/assets/img/font-nunito.svg" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-raleway">
                <input type="radio" name="font" id="font-raleway" value="font-raleway" />
                <span class="card p-2">
                  <img class="img-fluid" src="https://www.wrraptheme.com/templates/luno/assets/img/font-raleway.svg" alt="Dark Mode" />
                </span>
              </label>
            </div>
          </div>
          ...
          <div class="mb-4">
            <a class="btn lift  btn-outline-secondary" href="https://www.wrraptheme.com/templates/luno/marketing/index.html">Marketing page</a>
            <a class="btn lift  btn-outline-secondary" href="https://www.wrraptheme.com/templates/luno/onepgae-uikit/onepage.html">Landing page</a>
            <a class="btn lift  btn-outline-secondary" href="https://www.wrraptheme.com/templates/luno/onepgae-uikit/index.html">One page Ui Kit Elements</a>
          </div>
        </div>
