                                       ...
                                       <!--  <div class="add_room-item fl-wrap" >
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" placeholder="Standard Family Room" name="room[0][room_title]" value=""/>                
                                                </div>
                                                <div class="col-sm-6">
                                                    <label>Additional Room: <span class="dec-icon"><i class="fal fa-layer-plus"></i></span></label>
                                                    <input type="text" placeholder="Example: Sauna" name="room[0][additional_room]" value=""/>              
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="listsearch-input-item">
                                                        <textarea cols="40" rows="3" style="height: 175px;margin-bottom: 10px"  name="room[0][room_details]" placeholder="Datails" spellcheck="false"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="listsearch-input-item fl-wrap">
                                                         <div class="fuzone">
                                                            <div class="fu-text">
                                                             ...
                                                             <input type="file"  name="room[0][]" multiple>
                                                        </div>
                                                     </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" add-list-tags fl-wrap">
                                                ...
                                                <ul class="fl-wrap filter-tags no-list-style ds-tg">
                                                    <li>
                                                        <input id="check-2aaa5" type="checkbox" name="room[0][ac]" >
                                                        <label for="check-2aaa5">Air conditioner</label>
                                                    </li>
                                                    <li>
                                                        <input id="check-2bb5" type="checkbox" name="room[0][tv]" >
                                                        <label for="check-2bb5">Tv Inside</label>
                                                    </li>
                                                    <li>
                                                        <input id="check-2dd5" type="checkbox" name="room[0][cbath]">
                                                        <label for="check-2dd5"> Ceramic bath</label>
                                                    </li>
                                                    <li>
                                                        <input id="check-2cc5" type="checkbox" name="room[0][mic]" >
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input type="text" name="house[0][h_plan_title]" placeholder=" First Floor Plan " value=""/>    
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label>Plan Optional info: <span class="dec-icon"><i class="far fa-ruler-horizontal"></i></span></label>
                                                            <input type="text" name="house[0][h_plan_info]" placeholder="Example: 286 sq ft" value=""/> 
                                                        </div>
                                                    </div>
                                                    <label>Plan Details</label>
                                                    <div class="listsearch-input-item">
                                                        <textarea cols="40" rows="3" name="house[0][h_plan_details]" style="height: 85px;" placeholder="Datails" name="text1" spellcheck="false"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-5">
                                                 ...
                                                 <div class="listsearch-input-item fl-wrap">
                                                        <div class="fuzone">
                                                            ...
                                                            <input type="file"  name="house[0]" class="upload">
                                                        </div>
