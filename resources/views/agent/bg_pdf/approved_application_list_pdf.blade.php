...
<html>
    ...
    <body>
        <center><h1 class="text-center">Approved Application</h1></center>


        <h2>Total Approved Application: {{$total_application_approved->count()}}</h2>
            <table id="customers" class="table table-bordered">
                ...
                <tbody>
                    @forelse($total_application_approved as $key => $row)
                        <tr>
