                ...
                <th>Featured</th>
                                        ...
                                        <td>
                                         ...
                                         <span class="badge rounded-pill bg-primary mt-2 ml-4">  {{$row->price}}</span>
                                          @else
                                         <span class="badge rounded-pill bg-warning mt-2 ml-4">  NA </span>
                                          @endif</td>
                                        <td>{{ $row->created_at->format('Y-m-d') }}</td>
                                        <td>
                                           @if(!empty($row->user_id))
                                             <span class="badge rounded-pill bg-warning mt-2 ml-4"> USer </span> 
                                          @elseif(!empty($row->agent_id))
                                         <span class="badge rounded-pill bg-warning mt-2 ml-4"> Agent</span>
                                          @else
                                           <span class="badge rounded-pill bg-warning mt-2 ml-4"> ADMIN</span>
                                             @endif
