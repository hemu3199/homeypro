...
<html>
    ...
    <body>
        <center><h1 class="text-center">Rejected Application</h1></center>


        <h2>Total Rejected Application: {{$total_application_rejected->count()}}</h2>
            <table id="customers" class="table table-bordered">
                ...
                <tbody>
                    @forelse($total_application_rejected as $key => $row)
                        <tr>
