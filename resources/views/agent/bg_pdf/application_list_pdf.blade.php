...
<html>
    ...
    <body>
        <center><h1 class="text-center">Application Received</h1></center>


        <h2>Total Application Received: {{$total_application_recived->count()}}</h2>
            <table id="customers" class="table table-bordered">
                ...
                <tbody>
                    @forelse($total_application_recived as $key => $row)
                        <tr>
