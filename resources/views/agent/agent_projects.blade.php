            ...
            <div class="col-xl-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header  border-0">
                        ...
                        <button class="btn mx-2 btn-primary btn-animate-1" fdprocessedid="4mzvy8">
                                        <span>Click me</span>
                                        <i class="fa fa-long-arrow-right"></i>
                                    </button>
                                    <button class="btn mx-2 px-4 py-2 btn-outline-primary btn-animate-3" data-hover="click me!" fdprocessedid="kjngvdk"><div>Hover me!</div></button>
                            ...
                            <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
                                ...
                                @foreach($projects as $key => $row)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('agent.project_details',$row->project_id)}}">{{$row->project_name}}</a></td>
                                        ...
                                        <td><a href="{{ route('agent.project_edit_details',$row->project_id)}}">Edit Details</a></td>
                                        <td><a href="{{ route('agent.project_details',$row->project_id)}}">View Details</a></td>
