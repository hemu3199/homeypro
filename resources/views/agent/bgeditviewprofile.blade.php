...
@endif
  <form id="form" action="{{ route('agent.editbgagentprofile') }}" method="post" enctype="multipart/form-data">
   @csrf
                   ...
                   <div class="dasboard-widget-box nopad-dash-widget-box fl-wrap">
                                        ...
                                        <div class="change-photo-btn cpb-2  ">
                                            <div class="photoUpload color-bg">
                                                <span> <i class="fa fa-camera" aria-hidden="true"></i> Change Cover </span>
