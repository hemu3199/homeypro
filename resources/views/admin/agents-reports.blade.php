        ...
        <div class="col-xl-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-header  border-0">
                    <h4 class="card-title">Agent Reports List</h4>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-vcenter text-nowrap table-bordered border-bottom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="tablebtn color-bg" style="background-color: red" href="{{route('admin.delete-agents-report',$row->id)}}" role="button" aria-pressed="true"><i class='fas fa-trash-alt'></i></a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
