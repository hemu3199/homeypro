...
<head>
        ...
        <link rel="shortcut icon" href="{{asset('adminhomey/images/favicon.png ')}}" style="height: 50px; width: 100%;">
         <!-- Favicon-->
        <link rel="stylesheet" href="{{asset('adminhomey/assets/css/luno.style.min.css')}}">
        <script src="{{asset('adminhomey/assets/bundles/libscripts.bundle.js')}}"></script>
 ...
 window.onunload = function () { null };
    ...
    <body class="layout-1 font-nunito" data-luno="theme-blue">
        ...
        <div class="wrapper">
            ...
            <!-- start: page body -->
            <div class="page-body auth px-xl-4 px-sm-2 px-0 py-lg-2 py-1"  style="background-image: url('{{asset('adminhomey/assets/img/login-background.jpg')}}');opacity: 1;  " >
                <div class="container-fluid" >
                    <div class="row">
    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center" >
        <div style="max-width: 26rem;">
            <div class="mb-4" style="border-color: white;"><span >
                <img src="{{asset('adminhomey/images/logo.png')}}" style="width: 500px; margin-left: -50px; margin-top: -160px; border: 1px double white; border-width: 5px;">
            </span>
        </div>
            <div class="mb-5" style="margin-top:140px">
                <h2 class="text-white">Welcome To Admin Panel</h2>
