 ...
 <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h6 class="card-title mb-0"> Send Users Agreement</h6>
              </div>
              <div class="card-body">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-sm-6">
                    	...
                    	<label>User ID<span class="dec-icon"><i class="far fa-user"></i></span></label>
                  ...
                  <!--<div class="col-sm-12">
                    ...
                    <div class="card-body">
                        <div class="dashboard-search-listing">
                                        <input type="text" onkeyup="search()" id="search-item-table" placeholder="Search User Name" value="">
                        ...
                        <div class="table-responsive">
                            <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-bottom-0 w-10">User Id</th>
                                ...
                                @foreach($agreement as $key => $row)
                                    <tr>
                                        ...
                                        <td>
                                            {{DB::table('user_basic_info')->where(['user_id' => $row->member_id])->pluck('first_name')->first()}}</td>
                                        <td>
                                        ...
                                        <td><a href="{{url('uploads/agreement/'.$row->file)}}" class="tablebtn color-bg" target=”_blank”><i class="fa fa-eye" aria-hidden="true"></i></a>
                                             <a href="{{route('admin.edit-user-agreement',$row->id)}}"  class="tablebtn color-bg"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                            <a href="{{ route('admin.delete-user-agreement',$row->id)}}"  class="tablebtn" style="background-color:red;"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            ...
                            <nav aria-label="Page navigation"> {!! $agreement->links() !!}</nav>
                        </div>
                    </div>
                </div>
            </div>
