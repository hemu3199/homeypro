                            ...
                            <!-- start: page body -->
                              <div class="dasboard-wrapper fl-wrap">
                                  <div class="card-header  border-0">
                                      <h4 class="card-title " style="float: left;Font-size:20px;">Properties List</h4>
                        
                                             <a class="btn btn-primary btn-icon" href="{{route('admin.properties-pdf-download')}}"  style="margin-left: 10px; size: 40px;float:right ;">
                                            ...
                                            <tbody>
                                                @foreach($totalproperties as $key => $row)
                                                    <tr>
                                                        ...
                                                        <td>@if(!empty($row->price))
                                                        <span class="badge rounded-pill bg-primary mt-2 ml-4 " Style="padding:8px;">{{$row->price}}</span>
                                                        @else
                                                        ...
                                                        <td>
                                                            @if(!empty($row->user_id))
                                                          <span Style="padding:8px;" class="badge rounded-pill bg-success mt-2 ml-4">  {{$row->user_id}}</span>
                                                            @elseif(!empty($row->agent_id))
                                                           <span Style="padding:8px;" class="badge rounded-pill bg-success mt-2 ml-4">  {{$row->agent_id}}</span>
                                                            @else
                                                           <span Style="padding:8px;" class="badge rounded-pill bg-success mt-2 ml-4"> Admin</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                              @if($row->status==0)
                                                      <span Style="padding:8px;" class="badge rounded-pill bg-success mt-2 ml-4"> Active </span>
                                                        @else
                                                      <span  class="badge rounded-pill mt-2 ml-4" Style="background-color:orange;padding:8px;color:#fff;"> Inactive</span>
                                                        @endif
                                                        </td>
                                                           @if($row->status==0)
                                                        <td>
                                                        <a href="{{ route('admin.property_hide',$row->property_id)}}" style="background-color: green;border:none;" class="tablebtn"><i class="fa fa-toggle-on"></i></a></td>
                                                        @else
                                                         <td>
                                                        ...
                                                        @endif
                                                         @if($row->featured==0)
                                                        <td>
                                                        <a href="{{ route('admin.featured',$row->property_id)}}"  class="tablebtn" style="Background-color:green;"><i class="fa fa-star" aria-hidden="true"></i></a></td>
                                                        @else
                                                         <td>
                                                        ...
                                                        @endif
                                                        <td>
                                                            <a href="{{ route('admin.properties_details',$row->property_id)}}" class="tablebtn color-bg" target=”_blank”><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                        </td>
                                                        
                                                        <td>
                                                            <a href="{{ route('admin.property-rent-edit',$row->property_id)}}"  class="tablebtn color-bg"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
