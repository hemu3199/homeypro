 ...
 <div class="dashboard-menu-btn color-bg"><span><i class="fas fa-bars"></i></span>Dasboard Menu</div>
  <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
              ...
              <form method="post" action="{{route('admin.edit-Contactus-response',$contact_edit_details->contact_id)}}" id="form" enctype="multipart/form-data">
                                                @csrf
              <div class="card-header">
                <h6 class="card-title mb-0">Edit Users Contact Us Response </h6>
              </div>
              <div class="card-body">
                ...
                <div class="row g-3">
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control form-control-lg" name="name"placeholder="Enter here"  value="{{$contact_edit_details->name}}">
                  </div>
                  <div class="col-sm-6">
                     <label>Phone :<span class="dec-icon"><i class="far fa-user"></i></span></label>
                     <input type="text" class="form-control form-control-lg" name="phone" placeholder="Enter here"  value="{{$contact_edit_details->phone}}">
                  </div>
                   <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                     ...
                     <select data-placeholder="9 AM" name="time" class="chosen-select on-radius no-search-select">
                        <option value="09:00" {{$contact_edit_details->time == '09:00' ? 'selected' : ''}}>9 AM</option>
                        <option value="10:00" {{$contact_edit_details->time == '10:00' ? 'selected' : ''}}>10 AM</option>
                        <option value="11:00" {{$contact_edit_details->time == '11:00' ? 'selected' : ''}}>11 AM</option>
                        <option value="12:00" {{$contact_edit_details->time == '12:00' ? 'selected' : ''}}>12 AM</option>
                        <option value="13:00" {{$contact_edit_details->time == '13:00' ? 'selected' : ''}}>1 PM</option>
                        <option value="14:00" {{$contact_edit_details->time == '14:00' ? 'selected' : ''}}>2 PM</option>
                        <option value="15:00" {{$contact_edit_details->time == '15:00' ? 'selected' : ''}}>3 PM</option>
                        <option value="16:00" {{$contact_edit_details->time == '16:00' ? 'selected' : ''}}>4 PM</option>
                    </select>
                  ...
                  <!--<div class="col-sm-12">
                    ...
                    <div class="card-header  border-0">
                        <h4 class="card-title">Users Contact US response</h4>
                    </div>
                    <div class="card-body">
                        <div class="dashboard-search-listing">
                                        <input type="text" onkeyup="search()" id="search-item-table" placeholder="Search By User Name" value="">
                            ...
                            <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
                                ...
                                @foreach($usercontacus as $key => $row)
                                    <tr>
                                        ...
                                        <td>{{$row->date}}</td>
                                        <td>{{$row->time}}</td>
                                        <td> <span Style="padding:8px;" class="badge rounded-pill bg-success mt-2 ml-4">{{ $row->created_at->format('Y-m-d') }}
                                        </span></td>
                                         <td> 
                                            <!-- <a   class="btn btn-icon btn-sm color-bg faq-open"><i class="fa fa-trash-o" aria-hidden="true"></i></a> -->
                                            <a href="{{route('admin.edit-Contactus-response',$row->contact_id)}}"  class="tablebtn color-bg"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <a href="{{route('admin.delete-Contactus-response',$row->contact_id)}}"  style="background-color:red;" class="tablebtn color-bg"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                     </tr>
                                    @endforeach
