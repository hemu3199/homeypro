                            ...
                            <!-- start: page body -->
                              <div class="dasboard-wrapper fl-wrap">
                                  <div class="card-header  border-0">
                                      <h4 class="card-title " style="float: left;Font-size:20px;">Admin Properties Lists</h4>
                        
                                             <a class="btn btn-primary btn-icon" href="{{route('admin.admin-property-add')}}"  style="margin-left: 10px; size: 40px;float:right ;">
                                               <i class="feather feather-download" data-bs-toggle="tooltip"
                                                   data-original-title="#" style=""> ADD Properties</i>
                                           </a>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <span  class="badge rounded-pill mt-2 ml-4" Style="background-color:orange;padding:8px;color:#fff;"> Inactive</span>
                                                        @endif
                                                         ...
                                                         @if($row->status==0)
                                                        <td>
                                                        <a href="{{ route('admin.property_hide',$row->property_id)}}" style="background-color: green;" class="tablebtn  color-bg"><i class="fa fa-toggle-on"></i></a></td>
                                                        @else
                                                         <td>
                                                        <a href="{{ route('admin.property_show',$row->property_id)}}"  class="tablebtn"style="background-color:red"><i class="fa fa-toggle-off"></i></a></td>
                                                        @endif
                                                        ...
                                                        <!-- <td>edit</td> -->
                                                        <td><a href="{{ route('admin.properties_details',$row->property_id)}}" class="tablebtn color-bg"><i class="fa fa-eye"></i></a></td>
                                                         @if($row->featured==0)
                                                        <td>
                                                        ...
                                                        @endif
                                                        <td>
                                                            <a href="{{ route('admin.admin-property-rent-edit',$row->property_id)}}" class="tablebtn color-bg"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
