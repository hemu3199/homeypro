...
<body class="layout-1" data-luno="theme-red">
    ...
    <div class="container-fluid">
      ...
      <div class="main-menu flex-grow-1">
        <ul class="menu-list">
          ...
          <li>
            <a class="m-link active" href="Dashboard.php">
          ...
          <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="menu-Applications">
              <li> <a class="m-link" href="property-add-rent.php"><svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
  <path class="fill-secondary" d="M12.5 6.5h-1v-1h1v1zm0-3h-1v1h1V3zm-2 3h-1v-1h1v1zm0-3h-1v1h1V3zm-2 3h-1v-1h1v1zm0-3h-1v1h1V3zM4.5 7.5H3v1h1V7.5zm-1-3H3v1h.5V4.5zm0 6H3v1h.5v-1zm-1-3H3v1h.5V7.5zm8-5H2a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1zM9 14H3v-1h6v1zm4-3H3V4h10v7zm1 0v-1h1v1h-1zm0-3h1v1h-1V8zm0-3h1v1h-1V5z"/>
              ...
              <li> <a class="m-link" href="TotalProperties.php"><svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
            ...
            <li>
              <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button" data-bs-toggle="dropdown">
                  <img class="avatar img-thumbnail rounded-circle shadow" src="{{asset('agent/assets/img/avatar.png')}}" alt=" " style=" float: center;">
                </a>
                <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                  <div class="card border-0 w240">
                    <div class="card-body border-bottom d-flex">
                      <img class="avatar rounded-circle" src="{{asset('agent/assets/img/profile_av.png')}}" alt="">
                      <div class="flex-fill ms-3">
                        <h6 class="card-title mb-0">kshadg</h6>
                        <span class="text-muted">sad</span>
                      </div>
                    </div>
          ...
          <div class="col-xxl-9 col-xl-8 col-lg-12">
            <div class="row g-3 row-deck">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h6 class="card-title mb-0">Top Trending States</h6>
                    <div class="dropdown morphing scale-left">
                      <a href="#" class="card-fullscreen" data-bs-toggle="tooltip" title="Card Full-Screen"><i class="icon-size-fullscreen"></i></a>
                      <a href="#" class="more-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                      <ul class="dropdown-menu shadow border-0 p-2">
                  ...
                  <div class="card-body">
                    <div class="row g-3 row-deck mb-5">
                      <div class="col-sm-4">
                        <div class="card lift">
                          <div class="card-body">
                            <span class="text-uppercase mb-2 d-block">Telangana</span>
                            <div class="fs-6 d-flex align-items-baseline">
                              <h4 class="mb-0">21K</h4>
                              <small class="text-muted ms-2"><i class="fa fa-level-up"></i> 12%</small>
                            </div>
                      ...
                      <div class="col-sm-4">
                        <div class="card lift">
                          <div class="card-body">
                            <span class="text-uppercase mb-2 d-block">Karnataka</span>
                            <div class="fs-6 d-flex align-items-baseline">
                              <h4 class="mb-0">19K</h4>
                              <small class="text-muted ms-2"><i class="fa fa-level-down"></i> 8%</small>
                            </div>
                            <small class="text-muted">Analytics for last week</small>
                          </div>
                        </div>
                      ...
                      <div class="col-sm-4">
                        <div class="card lift">
                          <div class="card-body">
                            <span class="text-uppercase mb-2 d-block">Kerala</span>
                            <div class="fs-6 d-flex align-items-baseline">
                              <h4 class="mb-0">27K</h4>
                              <small class="text-muted ms-2"><i class="fa fa-level-up"></i> 28%</small>
                            </div>
                            <small class="text-muted">Analytics for last week</small>
                          </div>
                        </div>
                    ...
                    <!--<div id="india_mh" style="height: 240px;"></div>
                    <script src="{{asset('agent/assets/vendor/jvectormap/jquery-jvectormap-2.0.5.min.js')}}"></script>
                    <script src="{{asset('agent/assets/vendor/jquery-jvectormap-in-mill.js')}}"></script>
                    <!-/- India Analytics ->
                    <script>
                      $('#map').vectorMap({
                        map: 'india_mh',
                  ...
                  <div id="india_mh" style="height: 240px;"></div>
<script src="{{asset('agent/assets/vendor/jvectormap/jquery-jvectormap-2.0.5.min.js')}}"></script>
<script src="{{asset('agent/assets/vendor/jquery-jvectormap-in-merc.js')}}"></script>
<!-- India Analytics -->
<script>
  $('#india_mh').vectorMap({
    map: 'india_mh',
    ...
    series: {
      regions: [{
        values: {
          "IN-MH": 'var(--chart-color2)',
          "IN-DL": 'var(--chart-color3)',
          "IN-KA": 'var(--chart-color4)',
          "IN-TG": 'var(--chart-color5)',
          "IN-TN": 'var(--chart-color6)',
          "IN-WB": 'var(--chart-color7)'
        },
        attribute: 'fill'
      }]
    },
        ...
        <a href="#" class="col-md-4 d-flex align-items-center justify-content-center my-3 my-lg-0 me-lg-auto">
         <!-- <svg height="18" viewBox="0 0 67 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path class="fill-muted" d="M66.0301 10.0497C66.0301 11.433 65.8551 12.6913 65.5051 13.8247C65.1551 14.9413 64.6301 15.908 63.9301 16.7247C63.2467 17.5413 62.3884 18.1663 61.3551 18.5997C60.3384 19.033 59.1551 19.2497 57.8051 19.2497C56.4051 19.2497 55.1884 19.033 54.1551 18.5997C53.1217 18.1497 52.2634 17.5247 51.5801 16.7247C50.8967 15.908 50.3884 14.933 50.0551 13.7997C49.7217 12.6663 49.5551 11.408 49.5551 10.0247C49.5551 8.19135 49.8551 6.59135 50.4551 5.22468C51.0551 3.85801 51.9634 2.79135 53.1801 2.02468C54.4134 1.25801 55.9634 0.87468 57.8301 0.87468C59.6134 0.87468 61.1134 1.25801 62.3301 2.02468C63.5467 2.77468 64.4634 3.84135 65.0801 5.22468C65.7134 6.59135 66.0301 8.19968 66.0301 10.0497ZM51.9301 10.0497C51.9301 11.5497 52.1384 12.8413 52.5551 13.9247C52.9717 15.008 53.6134 15.8413 54.4801 16.4247C55.3634 17.008 56.4717 17.2997 57.8051 17.2997C59.1551 17.2997 60.2551 17.008 61.1051 16.4247C61.9717 15.8413 62.6134 15.008 63.0301 13.9247C63.4467 12.8413 63.6551 11.5497 63.6551 10.0497C63.6551 7.79968 63.1884 6.04135 62.2551 4.77468C61.3217 3.49135 59.8467 2.84968 57.8301 2.84968C56.4801 2.84968 55.3634 3.14135 54.4801 3.72468C53.6134 4.29135 52.9717 5.11635 52.5551 6.19968C52.1384 7.26635 51.9301 8.54968 51.9301 10.0497Z" />
              ...
              <img src="{{asset('agent/assets/img/HomeyLo.png')}}" alt="Homey" height="50" width="200">
        </a>
              ...
              <div class="card mb-3">
                ...
                <ul class="list-group list-group-flush list-group-custom custom_scroll mb-0" style="height: 300px;">
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('agent/assets/img/xs/avatar81.jpg')}}" alt="">
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('agent/assets/img/xs/avatar2.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('agent/assets/img/xs/avatar3.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('agent/assets/img/xs/avatar4.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('agent/assets/img/xs/avatar5.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('agent/assets/img/xs/avatar6.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('agent/assets/img/xs/avatar7.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('agent/assets/img/xs/avatar8.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
          ...
          <div class="ps-2">
            ...
            <div class="timeline-item ti-info p-3">
              <div class="timeline-icon">
                <img class="avatar sm rounded-circle" src="{{asset('agent/assets/img/xs/avatar1.jpg')}}" alt="">
              </div>
              <div class="timeline-content ms-3">
        ...
        <div class="d-flex align-items-start">
          <div class="nav flex-column nav-pills p-3 h-100">
            <a class="nav-link rounded-circle p-1 mb-2 active" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar1.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-2" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar2.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-3" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar3.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-2" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar4.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-5" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar5.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar6.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-7" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar7.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-3" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar8.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-3" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar9.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar10.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('agent/assets/img/xs/avatar5.jpg')}}" alt="avatar">
            </a>
                ...
                <div class="card-header border-bottom py-3">
                  <div class="d-flex">
                    <a href="javascript:void(0);" title="">
                      <img class="avatar rounded-circle" src="{{asset('agent/assets/img/xs/avatar1.jpg')}}" alt="avatar">
                    </a>
                    <div class="ms-3">
                    ...
                    <li class="mb-3 d-flex flex-row align-items-end">
                      <div class="max-width-70">
                        <div class="user-info mb-1">
                          <img class="avatar xs rounded-circle me-1" src="{{asset('agent/assets/img/xs/avatar1.jpg')}}" alt="avatar">
                      ...
                      <div class="max-width-70">
                        ...
                        <div class="card p-3">
                          <div class="message">
                            ...
                            <img class="w120 img-thumbnail" src="{{asset('agent/assets/img/gallery/3.jpg')}}" alt="">
                            <img class="w120 img-thumbnail" src="{{asset('agent/assets/img/gallery/4.jpg')}}" alt="">
                          </div>
                        </div>
                      </div>
                      <!-- More option -->
            ...
            <div class="tab-pane fade show active" id="c-user-2" role="tabpanel">
              <div class="card">
                ...
                <div class="card-header border-bottom py-3">
                  <div class="d-flex">
                    <a href="javascript:void(0);" title="">
                      <img class="avatar rounded-circle" src="{{asset('agent/assets/img/xs/avatar2.jpg')}}" alt="avatar">
                    </a>
                    <div class="ms-3">
                      <h6 class="mb-0">Orlando Lentz</h6>
                      <small class="text-muted">Last seen: 2 hours ago</small>
                ...
                <div class="card-body custom_scroll" style="height: calc(100vh - 141px);">
                  <ul class="list-unstyled chat-history flex-grow-1">
                    ...
                    <li class="mb-3 d-flex flex-row align-items-end">
                      <div class="max-width-70">
                        <div class="user-info mb-1">
                          <img class="avatar xs rounded-circle me-1" src="{{asset('agent/assets/img/xs/avatar2.jpg')}}" alt="avatar">
                          <span class="text-muted small">10:10 AM, Today</span>
                        </div>
                        <div class="card p-3">
                          <div class="message"> Hi Aiden, how are you?</div>
                    ...
                    <li class="mb-3 d-flex flex-row align-items-end">
                      <div class="max-width-70">
                        ...
                        <div class="card p-3">
                          <div class="message">
                            <p>Please find attached images</p>
                            <img class="w120 img-thumbnail" src="{{asset('agent/assets/img/gallery/1.jpg')}}" alt="">
                            <img class="w120 img-thumbnail" src="{{asset('agent/assets/img/gallery/2.jpg')}}" alt="">
                          </div>
                        </div>
                      </div>
                      <!-- More option -->
    ...
    <div class="modal-dialog modal-dialog-vertical right-side modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="px-xl-4 modal-body custom_scroll">
              ...
              <li class="list-group-item setting-img">
                ...
                <div class="bg-images">
                  <ul class="list-unstyled d-flex">
                    <li class="sidebar-img-1 me-1 sidebar-img-active"><a class="rounded sidebar-img" id="img-1" href="#"><img src="{{asset('agent/assets/img/sidebar-bg/sidebar-1.jpg')}}" alt="" /></a></li>
                    <li class="sidebar-img-2 me-1"><a class="rounded sidebar-img" id="img-2" href="#"><img src="{{asset('agent/assets/img/sidebar-bg/sidebar-2.jpg')}}" alt="" /></a></li>
                    <li class="sidebar-img-3 me-1"><a class="rounded sidebar-img" id="img-3" href="#"><img src="{{asset('agent/assets/img/sidebar-bg/sidebar-3.jpg')}}" alt="" /></a></li>
                    <li class="sidebar-img-4 me-1"><a class="rounded sidebar-img" id="img-4" href="#"><img src="{{asset('agent/assets/img/sidebar-bg/sidebar-4.jpg')}}" alt="" /></a></li>
                    <li class="sidebar-img-5 me-1"><a class="rounded sidebar-img" id="img-5" href="#"><img src="{{asset('agent/assets/img/sidebar-bg/sidebar-5.jpg')}}" alt="" /></a></li>
                  </ul>
                </div>
              </li>
          ...
          <div class="mb-4">
            <a class="btn lift  btn-outline-secondary" href="https://www.wrraptheme.com/templates/luno/marketing/index.php">Marketing page</a>
            ...
            <a class="btn lift  btn-outline-secondary" href="https://www.wrraptheme.com/templates/luno/onepgae-uikit/index.php">One page Ui Kit Elements</a>
          </div>
        </div>
  ...
  <!-- Jquery Page Js -->
  <!-- Jquery Page Js -->
  <script src="{{asset('agent/assets/js/theme.js')}}"></script>
  <!-- Plugin Js -->
  <script src="{{asset('agent/assets/js/bundle/apexcharts.bundle.js')}}"></script>
  <!-- Vendor Script -->
  <script src="{{asset('agent/assets/js/bundle/apexcharts.bundle.js')}}"></script>
  <script>
