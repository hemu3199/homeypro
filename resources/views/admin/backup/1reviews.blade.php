...
<div class="dashboard-content">
                        ...
                        <table class="table table-vcenter text-nowrap table-bordered border-bottom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @else
                                    <td>
                                        <a class="tablebtn" href="{{ route('admin.approve.reviews',$row->id) }}" role="button" aria-pressed="true" style="background-color:blue">Approve</a>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="dashboard-search-listing">
                <input type="text" onkeyup="searchdeleted()" id="search-item-tables" placeholder="Search deleted Review" value="">
                <button type="submit"><i class="fa fa-search"></i></button>
            </div>
            <div class="table-responsive">
