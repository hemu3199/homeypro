 ...
 <div class="dashboard-menu-btn color-bg"><span><i class="fas fa-bars"></i></span>Dasboard Menu</div>
  <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
              ...
              <form method="post" action="{{route('admin.edit-bgagent-Contactus-response',$contact_edit_details->id)}}" id="form" enctype="multipart/form-data">
                                                @csrf
              <div class="card-header">
                <h6 class="card-title mb-0">Edit BG Agent Contact Us Response </h6>
              </div>
              <div class="card-body">
                ...
                <div class="row g-3">
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control form-control-lg" name="name"placeholder="Enter here"  value="{{$contact_edit_details->bg_agent_name}}" disabled>
                  </div>
                  <div class="col-sm-6">
                     <label>Phone :<span class="dec-icon"><i class="far fa-user"></i></span></label>
                     <input type="text" class="form-control form-control-lg" name="phone" placeholder="Enter here"  value="{{$contact_edit_details->bg_agent_phone}}">
                  </div>
                   <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                     ...
                     <select data-placeholder="9 AM" name="time" class="chosen-select on-radius no-search-select">
                        ...
                        <option value="15:00" {{$contact_edit_details->time == '15:00:00:00' ? 'selected' : ''}}>3 PM</option>
                ...
                <div class="col-sm-6">
                  ...
                  <!--<div class="col-sm-12">
                    ...
                    <div class="card-header  border-0">
                        <h4 class="card-title">Contact US BG Agent's Respons</h4>
                    </div>
                    <div class="card-body">
                        <div class="dashboard-search-listing">
                                        <input type="text" onkeyup="search()" id="search-item-table" placeholder="Search By Agent Name" value="">
                            ...
                            <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
                                ...
                                @foreach($agentcontacus as $key => $row)
                                    <tr>
                                        ...
                                        <td><span Style="padding:8px;" class="badge rounded-pill bg-success mt-2 ml-4">{{ $row->bg_agent_id}}
                                        </span></td>
                                        <td>{{$row->bg_agent_name}}</td>
                                        <td>{{$row->bg_agent_phone}}</td>
                                        <td>{{$row->message}}</td>
                                        <td>{{$row->date}}</td>
                                        <td>{{$row->time}}</td>
                                         ...
                                         <td>
                                         <a href="{{route('admin.edit-bgagent-Contactus-response',$row->id)}}"  class="tablebtn color-bg"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                          <a href="{{route('admin.delete-bgagent-Contactus-response',$row->id)}}"  class="tablebtn" style="background-color:red"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                     </tr>
                                    @endforeach
