...
<div class="dashboard-content">
 ...
 <div class="row">
            ...
            <div class="card">
              ...
              <form method="post" action="{{route('admin.edit-user-agreement',$agreement->id)}}" id="form" enctype="multipart/form-data">
                                                @csrf
              <div class="card-header">
                <h6 class="card-title mb-0"> Update User Agreement</h6>
              </div>
              <div class="card-body">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-sm-6">
                        ...
                        <label>Update User ID * <span class="dec-icon"><i class="far fa-user"></i></span></label>
