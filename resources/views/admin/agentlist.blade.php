                ...
                <div class="card">
                        ...
                        <div class="card-header  border-0">
                            <h4 class="card-title">Agent List</h4>
                                ...
                                <a class="btn btn-primary btn-icon" href="{{ route('admin.addagent_form')}}"  style="margin-left: 10px; size: 40px; text-align: right;">
                                                   Add Agent
                                               </a>
                                ...
                                <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
                                    ...
                                    @foreach($agentlist as $key => $row)
                                        <tr>
                                            ...
                                            <td> <span Style="padding:8px;" class="badge rounded-pill bg-success mt-2 ml-4">{{$row->agent_id}}<span></span></td>
                                            <td>{{$row->name}}</td>
                                            <td>{{$row->email}}</td>
