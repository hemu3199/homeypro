...
@endphp
                ...
                <div class="dashboard-content">
                    ...
                    <div class="container dasboard-container">
                        ...
                        <div class="dashboard-title fl-wrap">
                            <div class="dashboard-title-item"><span>View Testimonial</span></div>
    ...
    @endif
                           <form method="post" action="{{ route('users-testimonilas-edit',$application_details->id) }}" id="form">
                                                @csrf
                       <div class="dasboard-widget-title fl-wrap">
                                    ...
                                    <div class="dasboard-widget-box fl-wrap">
                                        ...
                                        <button class="btn big-btn color-bg float-btn">Edit Testimonial <i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
                                    </div>  
                                </form>
                    </div>
