                ...
                @endif
                    ...
                    <div class="container dasboard-container">
                        ...
                        <div class="dashboard-title fl-wrap">
                            <div class="dashboard-title-item"><span>Your Agents Reviews</span></div>
                                                ...
                                                <table class="table table-vcenter text-nowrap table-bordered border-bottom">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                         ...
                                                         <td>    @if(!empty($row->rating))
                                                            @if ($row->rating == '1')
                                                           <i class='fas fa-star' style="color: yellow"></i>
                                                            @elseif ($row->rating == '2')
                                                           <i class='fas fa-star' style="color: yellow"></i><i class='fas fa-star' style="color: yellow"></i>
                                                            @elseif ($row->rating == '3')
                                                           <i class='fas fa-star' style="color: yellow"></i><i class='fas fa-star' style="color: yellow"></i><i class='fas fa-star' style="color: yellow"></i>
                                                            @elseif ($row->rating == '4')
                                                         <i class='fas fa-star' style="color: yellow"></i><i class='fas fa-star' style="color: yellow"></i><i class='fas fa-star' style="color: yellow"></i><i class='fas fa-star' style="color: yellow"></i>
                                                            @elseif ($row->rating == '5')
                                                            ...
                                                            @endif
                                                            @else
                                                        <span class="tablebtn" style="background-color:black; border-radius:20px; width:10px;">NA</span>    
                                                            @endif
                                                            </td>
                                                          
                                                            <td>
                                                                <!-- <a class="tablebtn color-bg" href="{{ route('users-view-application',$row->property_id) }}" aria-pressed="true"><i class='fa fa-eye'></i></a> -->
                                                                <a class="tablebtn color-bg" href="{{route('edit-agent-review',$row->id)}}" role="button" aria-pressed="true"><i class='fa fa-edit'></i></a>
                                                                <a class="tablebtn color-bg" style="background-color: red" href="{{route('delete-agent-review',$row->id)}}" role="button" aria-pressed="true"><i class='fas fa-trash-alt'></i></a>
                                                            </td>
                                                        </tr>
                                                        @empty
                                                        <tr>
