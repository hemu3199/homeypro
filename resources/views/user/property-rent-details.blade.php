                        ...
                        <div class="container">
                            ...
                            <a class="print-btn tolt" href="javascript:window.print()" data-microtip-position="bottom"  data-tooltip="Print"><i class="fas fa-print"></i></a>
                              ...
                              @else
                                    ...
                                    @endphp
                                    @if ( $compare < 4)
                                    @php $compareadd = DB::table('compare')->where('property_id', $property_rent_details->property_id)
                                    ...
                                    @endphp
                                        ...
                                        @else
                                        <a class="compare-top-btn tolt" data-microtip-position="bottom"  data-tooltip="Compare" href="{{route('compareadd',  $property_rent_details->property_id)}}"><i class="fas fa-random"></i></a>  
                                        @endif
                                    @else
                                    ...
                                    <div class="list-single-main-wrapper fl-wrap">
                                        ...
                                        <div class="list-single-header-item  fl-wrap" id="sec1">
                                            ...
                                            <div class="list-single-header-footer fl-wrap">
                                                ...
                                                <div class="list-single-header-date"><span>Date:</span>{{date('Y-m-d', strtotime($property_rent_details->updated_at))}}</div>
                                                ...
                                                <div class="list-single-main-item_content fl-wrap">
                                                    <div class="details-list">
                                                        <ul>
                                                            ...
                                                            <li><span>Available from:</span>{{date('Y-m-d', strtotime($property_rent_details->updated_at))}}</li>
                                                            ...
                                                            <div class="reviews-comments-item">
                                                                ...
                                                                <div class="reviews-comments-item-text smpar">
                                                                    ...
                                                                    <div class="reviews-comments-item-date"><span class="reviews-comments-item-date-item"><i class="far fa-calendar-check"></i>
                                                                        ...
                                                                        @php
                                                                            $existingLike = \App\Models\LikeReview::where('review_id', $review->id)->where('property_id', $property_rent_details->property_id)->exists();
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="box-widget fl-wrap">
                                               ...
                                               <div class="show-more-snopt-tooltip bxwt">
                                                ...
                                                <div class="profile-widget-card">
                                                    ...
                                                    <div class="profile-widget-header-title">
                                                        ...
                                                        <div class="clearfix"></div>
                                                        <div class="pwh_counter"><span>{{DB::table('homeyproperties')->where('property_deleted',0)
                                                        ->where('agent_id', $property_rent_details->agent_id )->where('approval_status','=', 1 )
                                                        ->count();}}</span>Property Listings</div>
                                                        <div class="clearfix"></div>
                                                        <div class="listing-rating card-popup-rainingvis" data-starrating2="{{DB::table('agent_reviews')
                                    ...
                                    <div class="box-widget fl-wrap">
                                            ...
                                            <div class="profile-widget-header color-bg smpar fl-wrap">
                                                ...
                                                <div class="profile-widget-card">
                                                    ...
                                                    <div class="profile-widget-header-title">
                                                        ...
                                                        <div class="clearfix"></div>
                                                                                              @php
                                        $property_count = DB::table('homeyproperties')
                                            ->where('property_deleted', 0)
                                            ->where('user_id', $property_rent_details->user_id)
                                            ->where('approval_status', '=', 1)
                                            ->count();
                                        
                                        if (!empty($property_count)) {
                                            $count_properties = $property_count;
                                        } else {
                                            $count_properties = DB::table('homeyproperties')
                                                ->where('user_id', 0)
                                                ->where('agent_id', 0)
                                                ->where('property_deleted', 0)
                                                ->where('approval_status', '=', 1)
                                        ...
                                        <div class="pwh_counter"><span>{{$count_properties}}</span>Property Listings</div>

                                                        <div class="clearfix"></div>
                                                        @php
                                                                  $avg_rating=DB::table('agent_reviews')
                                                        ->where('member_id', $property_rent_details->user_id )
                                                        ->count('rating');
                                                        if(!empty($avg_rating))
                                                        ...
                                                        <div class="listing-rating card-popup-rainingvis" data-starrating2="{{$avg_rating_count}}"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="profile-widget-content fl-wrap">
                                    ...
                                    <div class="box-widget fl-wrap">
                                        ...
                                        <div class="box-widget-content fl-wrap">
                                                    ...
                                                    <li>
                                                       ...
                                                       $bookmark = DB::table('property_images')->where('property_id', $item->property_id)
                                                        ...
                                                        <div class="widget-posts-descr">
                                                            <h4><a href="{{ route('users-property-rent-details', $item->property_id) }}">{{ optional($item)->name}}</a></h4>
                                                            <div class="geodir-category-location fl-wrap"><a ><i class="fas fa-map-marker-alt"></i> {{ optional($item)->address}}</a></div>
                                            ...
                                            <!-- widget-posts end-->                      @if(!empty($property_rent->count()))                                     
                                            <a href="{{ route('users-featured') }}" class="btn float-btn color-bg small-btn">View All Properties</a>
                                            @else
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="listing-item">
                                            <article class="geodir-category-listing fl-wrap">
                                                <div class="geodir-category-img fl-wrap">
                                                    ...
                                                    @else
                                                        @php $bookmarks = DB::table('bookmark_property')->where('property_id', $row->property_id)
                                                        ->where('user_id', Auth::guard('web')->user()->user_id)
                                                        ->first();
                                                        @endphp
                                                    ...
                                                    @else
                                                    <a href="{{ route('users-property-bookmark', $row->property_id) }}" class="geodir_save-btn tolt" data-microtip-position="left" data-tooltip="Bookmark" ><span><i class="fal fa-heart"></i></span></a>
                                                    ...
                                                    @endphp
                                                    @if ( $compare < 4)
                                                         @php $compareadd = DB::table('compare')->where('property_id', $row->property_id)
                                                            ->where('user_id', Auth::guard('web')->user()->user_id)
                                                            ->count();
                                                        @endphp
                                                        @if($compareadd == 1 )
                                                        ...
                                                        @else
                                                        <a href="{{route('compareadd',  $row->property_id)}}" class="compare-btn tolt" data-microtip-position="left" data-tooltip="Compare"><span><i class="fal fa-random"></i></span></a >  
                                                        @endif
                                                    @else
                                                    <a href="{{ route('compare') }}" class="compare-btn tolt" data-microtip-position="left" data-tooltip="Compare Full" ><span><i class="fal fa-random"></i></span></a>
                                                    @endif
                                                 @endif 
                                                ...
                                                <div class="geodir-category-content fl-wrap">
                                                    ...
                                                    <p class="para">{{$row->key_words}}</p>
                                                    <div class="geodir-category-content-details">
                                                        <ul>
                                                            <li><i class="fal fa-bed"></i><span>3</span></li>
                                                            <li><i class="fal fa-bath"></i><span>2</span></li>
                                                            <li><i class="fal fa-cube"></i><span>420 ft2</span></li>
                                                        </ul>
                                                    </div>
                                                     <div class="geodir-category-footer fl-wrap">
                                                                   @php 
                                                                $agent=DB::table('agents')->where('agent_id',$row->agent_id)->first();
                                                                $agentbasicinformation=DB::table('agent_basic_information')->where('agent_id',$row->agent_id)->first();
                                                                @endphp
                                                                @if(!empty($agent))
                                                                <a  class="gcf-company"><img src="{{url('/uploads/agents/'.$agentbasicinformation->file)}}" alt=""><span>By {{$agentbasicinformation->fname}}</span></a>
                                                                @php
                                                                $avg_rating_count=DB::table('agent_reviews')
                                                        ->where('member_id', $row->agent_id )
                                                        ->avg('rating');
                                                                @endphp
