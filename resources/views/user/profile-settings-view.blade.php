...
@section  ("content")       
                ...
                <div class="dashboard-content">
                    ...
                    <div class="container dasboard-container">
                        ...
                        <div class="dasboard-wrapper fl-wrap no-pag">
                            <div class="row">
                                <form method="post" action="users-profile-setting-edit" id="form" enctype="multipart/form-data">
                            @csrf
                                <div class="col-md-7">
                ...
                @endphp
                                            ...
                                            @if(!empty($profilepic))
                                              <img src="{{url('/uploads/user-profile/'.$profilepic)}}" name="profile_pic" class="respimg" alt="">
                                        ...
                                        <div class="bg-wrap bg-parallax-wrap-gradien">
                                            <div class="bg"  data-bg="{{url('/uploads/user-profile/'.DB::table('user_basic_info')->where(['user_id' => auth()->user()->user_id])->pluck('cover_pic')->first())}}"></div>
                                        </div>
                                    ...
                                    <div class="dasboard-widget-box fl-wrap">
                                        <div class="custom-form">
                                            ...
                                            <input type="text" name="first_name" placeholder="Alica" value="{{$userinfo->first_name}}"/>
                                            <label>Second Name <span class="dec-icon"><i class="fas fa-user"></i></span></label>
                                            <input type="text" name="last_name" placeholder="Noory" value="{{optional($userinfo)->last_name}}"/>
                                            <label>Email Address <span class="dec-icon"><i class="far fa-envelope"></i></span></label>
                                            <input type="text" name="email" placeholder="AlicaNoory@domain.com" value="{{optional($userinfo)->email}}"/>   
                                            <label>Phone<span class="dec-icon"><i class="far fa-phone"></i> </span></label>
                                            <input type="text" name="phone_no" placeholder="+7(123)987654" value="{{optional($userinfo)->phone_no}}"/>   
                                            <label>Address <span class="dec-icon"><i class="fas fa-map-marker"></i> </span></label>
                                            <input type="text" name="address" placeholder="USA 27TH Brooklyn NY" value="{{optional($userinfo)->address}}"/> 
                                            <label>Nationality <span class="dec-icon"><i class="fas fa-globe"></i> </span></label>
                                            <input type="text" name="nationality" placeholder="USA 27TH Brooklyn NY" value="{{optional($userinfo)->nationality}}"/>  
                                        ...
                                        <div class="listsearch-input-item">
                                           <select name="gender"  class="chosen-select no-search-select">
                                            ...
                                            <label>Notes </label>
                                            <textarea cols="40" name="note" rows="3" placeholder="About Me" style="margin-bottom:20px;" >{{optional($userinfo)->note}}</textarea>                                     
                                ...
                                <div class="col-md-5">
                                    <div class="dasboard-widget-title dbt-mm fl-wrap">
                                     ...
                                     <form method="post" action="update-users-password" enctype="multipart/form-data" > 
                                        <!--<form>-->
                                        @csrf
                                    <div class="dasboard-widget-box fl-wrap">
                                        <div class="custom-form">
                                            <div class="pass-input-wrap fl-wrap">
                                                ...
                                                <input type="password" class="pass-input" name="currentpassword" placeholder="" value=""/>
                                            ...
                                            <div class="pass-input-wrap fl-wrap">
                                                ...
                                                <input type="password" class="pass-input" name="newpassword" placeholder="" value=""/>
                                                <span class="eye"><i class="far fa-eye" aria-hidden="true"></i> </span>
                                            </div>
                                            <div class="pass-input-wrap fl-wrap">
                                                <label>Confirm New Password<span class="dec-icon"><i class="far fa-shield-check"></i> </span></label>
                                                <input type="password" class="pass-input" name="cpassword" placeholder="" value=""/>
                                                <span class="eye"><i class="far fa-eye" aria-hidden="true"></i> </span>
                                            </div>
                                            <button class="btn    color-bg  float-btn">Save Changes</button>
                                        </div>
