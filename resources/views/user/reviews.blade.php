                ...
                @if ($errors->any())
                    ...
                    <div class="container dasboard-container">
                        ...
                        <div class="dashboard-title fl-wrap">
                            <div class="dashboard-title-item"><span>Your Property Reviews</span></div>
                                                ...
                                                <table class="table table-vcenter text-nowrap table-bordered border-bottom">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span class="tablebtn" style="background-color:green; border-radius:20px; width:10px;">{{ $row->user_id }}</span></td>
                                                            <td>{{ $row->user_name }}</td>
                                                            ...
                                                            @else
                                                            <td><a class="tablebtn" style="background-color:orange">Pending</a></td>
                                                            @endif
                                                            <td>
                                                                <!-- <a class="tablebtn color-bg" href="{{ route('users-view-application',$row->property_id) }}" aria-pressed="true"><i class='fa fa-eye'></i></a> -->
                                                                <a class="tablebtn color-bg" href="{{ route('users-reviews-edit',$row->id) }}" role="button" aria-pressed="true"><i class='fa fa-edit'></i></a>
                                                                <a class="tablebtn color-bg" style="background-color: red" href="{{ route('users-delete-reviews',$row->id) }}" role="button" aria-pressed="true"><i class='fas fa-trash-alt'></i></a>
                                                            </td>
                                                        </tr>
                                                        @empty
                                                        <tr>
