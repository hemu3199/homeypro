                ...
                <div class="dashboard-content">
                    ...
                    <div class="container dasboard-container">
                        ...
                        <div class="dashboard-title fl-wrap">
                            <div class="dashboard-title-item"><span>Your Interested Property Listings</span></div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="dashboard-listings-item fl-wrap">
                                                ...
                                                <div class="dashboard-listings-item_content">
                                                    <h4><a href="{{ route('users-property-rent-details', $item->property_id) }}">{{DB::table('homeyproperties')->where(['property_id' => $item->property_id])->pluck('name')->first()}}</a></h4>
                                                    <div class="geodir-category-location">
                                                        <a href="#" class="twolinetext"><i class="fas fa-map-marker-alt"></i> <span>  {{DB::table('homeyproperties')->where(['property_id' => $item->property_id])->pluck('address')->first()}}</span></a>
                                                    </div>
                                                    ...
                                                    <div class="dashboard-listings-item_opt">
                                                        <span class="viewed-counter"><a href="#">{{DB::table('homeyproperties')->where(['property_id' => $item->property_id])->pluck('categories')->first()}}</a></span>
                                                        <!-- <span class="viewed-counter"><i class="fas fa-eye"></i> Viewed -  645 </span> -->
                                                        <ul>
                                                            <!-- <li><a href="{{ route('users-edit-properties',$item->property_id) }}" class="tolt" data-microtip-position="top-left"  data-tooltip="Edit"><i class="far fa-edit"></i></a></li>
                                                            <li><a href="#" class="tolt" data-microtip-position="top-left"  data-tooltip="Disable"><i class="far fa-signal-alt-slash"></i></a></li> -->
                                                             @php
                                                            $status=DB::table('homeyproperties')
                                                        ->where('property_id', $item->property_id)
                                                        ->pluck('status')->first();
                                                            @endphp
                                                            <li>@if($status == 0)
                                                           <a class="tolt" data-microtip-position="top-left"  data-tooltip="Active" data-microtip-position="top-left"   ><i class="fa fa-toggle-on" aria-hidden="true"></i></a>
                                                            @else
                                                            <a class="tolt" data-microtip-position="top-left"  data-tooltip="Inactive"  data-microtip-position="top-left" style="color:red;" > <i class="fa fa-toggle-off" aria-hidden="true"></i></a>
                                                            @endif</a></li> 
                                                            <li><a  href="{{route('users-delete-intrested',$item->property_id)}}" class="tolt" data-microtip-position="top-left"  data-tooltip="Delete" style="color:red;"><i class="far fa-trash-alt"></i></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
