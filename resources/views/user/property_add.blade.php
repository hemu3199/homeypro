...
@section  ("content")       
          ...
          <div class="dashboard-content">
                    ...
                    <div class="container dasboard-container">
                        ...
                        <!-- dashboard-title end -->  
                     <form method="post" action="add-propertyfun" id="form" enctype="multipart/form-data">   
                             @csrf
                                ...
                                <div class="custom-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <!--  </div>-->
                                            ...
                                            <label>City</label>
                                            <div class="listsearch-input-item">
                                                <select data-placeholder="city" name="cities" class="chosen-select no-search-select"  type="text" id= "selectrefer" onchange="onSelectRefer()" >
                                                    @php
                                            ...
                                            <input type="text" name="city" id="yourTextBoxrefer" placeholder="Please Your City" style="visibility:hidden;"/>
                                        </div>
                                        <div class="col-sm-4">
...
<script>
function onSelectRefer(){
    var sel = document.getElementById('selectrefer');
    var strUser = sel.options[sel.selectedIndex].text;  //getting the selected option's text
    if(strUser == 'Other'){
         document.getElementById('yourTextBoxrefer').style.visibility = 'visible';  //enabling the text box because user selected 'Other' option.
    } else {
         document.getElementById('yourTextBoxrefer').style.visibility = 'hidden';
    }
}
    </script>
</script>
