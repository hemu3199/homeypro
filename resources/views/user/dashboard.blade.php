                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="dashboard-stats fl-wrap">
                                            ...
                                            <div class="dashboard-stats-count">{{ $total_verified_properties }}</div>
                                        </div>
                                    </div>
                                    <!-- dashboard-stats end -->
                                    <!--dashboard-stats-->
                                    <!-- <div class="col-md-3">
                                        <div class="dashboard-stats fl-wrap">
                                            ...
                                            <div class="dashboard-stats-count"><span>(<strong>+1</strong> This week)</span></div>
                                        </div>
                                    </div> -->
                                    <!-- dashboard-stats end -->
                                    <!--dashboard-stats-->
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                   <!--  <div class="notification success-notif  fl-wrap">
                                    ...
                                    <div class="dashboard-widget-title fl-wrap">Latest Bookmarked Properties</div>
                                    <div class="dashboard-list-box  fl-wrap">
                                         @foreach ($latestBookmarkProperty as  $item)
                                        <!-- dashboard-list end-->
                                        <div class="dashboard-list fl-wrap">
                                            <div class="dashboard-message">
                                                ...
                                                <div class="main-dashboard-message-text">
                                                    @php
                                                    $property_details=DB::table('homeyproperties')->where('property_id', $item->property_id)->where('property_deleted',$item->property_id)
                                                    ->first();
                                                    @endphp
                                                    <p><a href="{{ route('users-property-rent-details', $item->property_id) }}">{{ optional($property_details)->name}}</a> has been Bookmarked! </p>
                                                </div>
                                                <div class="main-dashboard-message-time"><i class="fal fa-calendar-week"></i> {{date('Y-m-d', strtotime($item->created_at))}}</div>
                                            </div>
                                        </div>
                                        <!-- dashboard-list end-->
                                       @endforeach
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="dasboard-widget fl-wrap">
                                        <div class="dasboard-widget-title fl-wrap">
                                            <h5><i class="fas fa-house"></i>Latest Properties</h5>
                                        </div>
