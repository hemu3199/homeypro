                ...
                <div class="dashboard-content">
                    ...
                    <div class="container dasboard-container">
                        ...
                        <div class="dashboard-title fl-wrap">
                            <div class="dashboard-title-item"><span>Your BookMarked Property Listings</span></div>
                                                    ...
                                                    <div class="dashboard-listings-item_opt">
                                                        ...
                                                        ->pluck('status')->first();
                                                           ...
                                                           <a class="tolt" data-microtip-position="top-left"  data-tooltip="Active" data-microtip-position="top-left"   ><i class="fa fa-toggle-on" aria-hidden="true"></i></a>
                                                            ...
                                                            @endif</a></li> 
                                                            <li><a  href="{{route('users-delete-bookmark',$item->property_id)}}" class="tolt" data-microtip-position="top-left"  data-tooltip="Delete" style="color:red;"><i class="far fa-trash-alt"></i></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
