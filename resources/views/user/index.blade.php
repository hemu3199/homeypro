...
@section  ("content")        <!-- header end  -->	
            ...
            <div id="wrapper">
                ...
                <div class="content">
                        ...
                        <div class="hero-slider-wrap carousel-wrap fl-wrap">
                            <div class="hero-slider carousel" >
                                ...
                                <div class="hero-slider-item hero-slider-item_first fl-wrap">
                                    <div class="bg"  data-bg=" {{asset('homey/images/bg/1.png')}}"></div>
                        ...
                        <div class="container">
                            ...
                            <!-- grid-item-holder-->
                              <div class="grid-item-holder gallery-items gisp fl-wrap">
                                    ...
                                    @else
                                     ...
                                     @endif
                                                <div class="geodir-category-location">
                                                    <a href="#" class="single-map-item tolt" data-newlatitude="{{optional($item)->latitude}}" data-newlongitude="{{optional($item)->longitude}}"   data-microtip-position="top-left" data-tooltip="On the map"><i class="fas fa-map-marker-alt"></i> <span>  {{ optional($item)->address}}</span></a>
                                                </div>
                                                <ul class="list-single-opt_header_cat">
                                                    <li><a href="#" class="cat-opt ">New</a></li>
                                                    <li><a href="#" class="cat-opt ">{{$item->categories}}</a></li>
                                                </ul>
                                ...
                                @else
                                <a href="{{ route('users-property-bookmark', ['id' => $item->property_id]) }}" class="geodir_save-btn tolt" data-microtip-position="left" data-tooltip="Bookmark" ><span><i class="fal fa-heart"></i></span></a>
                                     ...
                                     <div class="geodir-category-listing_media-list">
                                                    ...
                                                    <div class="geodir-category-content fl-wrap">
                                                        ...
                                                        <div class="geodir-category-content-details">
                                                            <ul>
                                                                <li><i class="fal fa-bed"></i><span>{{$item->bedrooms}}</span></li>
                                                                <li><i class="fal fa-bath"></i><span>{{$item->bathrooms}}</span></li>
                                                                <li><i class="fal fa-cube"></i><span>{{$item->area}}</span></li>
                                                            </ul>
                                                        </div>
                    ...
                    <!-- section end-->
                    <!-- section -->
                    @if(!empty($featured_properties->count()))
                                    ...
                                    @if (Auth::guest())
                                     ...
                                     @else
                                        ...
                                        @if ( $compare < 4)
                                            ...
                                            @endif
                                        @else
                                        <a href="{{ route('compare') }}" class="compare-btn tolt" data-microtip-position="left" data-tooltip="Bookmark" ><span><i class="fal fa-random"></i></span></a>
                                        @endif
                                     @endif 
                                     <div class="geodir-category-listing_media-list">
                                                            <span><i class="fas fa-camera"></i> {{$imagescount}}</span>
                                ...
                                <div class="half-carousel fl-wrap full-height">
                                   ...
                                   <!--  @foreach($cities as $key =>$row)
                                    ...
                                    <div class="slick-item">
                                        <div class="half-carousel-item fl-wrap">
                                            <div class="bg-wrap bg-parallax-wrap-gradien">
                                                <div class="bg"  data-bg="{{url('/uploads/cities/'.$row->city_image)}}"></div>
                                            </div>
                                            <div class="half-carousel-content">
                                                <div class="hc-counter ">10</div>
                                                <h3><a href="#">{{$row->city_name}}</a></h3>
                                                <p>{{$row->city_description}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                        ...
                        <div class="container">
                            ...
                            <div class="listing-carousel-wrapper lc_hero carousel-wrap fl-wrap">
                                <div class="listing-carousel carousel ">
                                    ...
                                    <!-- slick-slide-item -->
                                    @php
                                    $agentbasicinformation=DB::table('agent_basic_information')->where('agent_id',$agents->agent_id)->first();
                                    @endphp
                                    <div class="slick-slide-item" style="height: 500px;">
                                        <!--  agent card item -->
                                        <div class="listing-item">
                                            <article class="geodir-category-listing fl-wrap">
                                                <div class="geodir-category-img fl-wrap  agent_card">
                                                    <a  class="geodir-category-img_item">
                                                        ...
                                                        @if(!empty($agentbasicinformation->file))
                                                        <img src="{{url('/uploads/agents/'.$agentbasicinformation->file)}}" style="height: 300px;" alt="">
                                                        @else
                                                       <img src="{{asset('../homey/images/dummy-profile-pic.png')}}" alt="">

                                                        @endif
                                                        <ul class="list-single-opt_header_cat">
                                                            <li><span class="cat-opt ">{{DB::table('homeyproperties')->where('agent_id',$agents->agent_id)->where('property_deleted',0)->where('approval_status', '=', 1)->count()}}</span></li>
                                                        </ul>
                                                    </a>
                                                    ...
                                                    @php
                                                                $avg_rating_count=DB::table('agent_reviews')
                                                        ->where('member_id', $agents->agent_id )
                                                        ->avg('rating');
                                                                @endphp
                                                    <div class="listing-rating card-popup-rainingvis" data-starrating2="{{$avg_rating_count}}"><span class="re_stars-title">@if(5<=$avg_rating_count)
                                                Excellent
                                            @elseif(4<=$avg_rating_count)
                                                Good
                                            @elseif(3<=$avg_rating_count)
                                            ...
                                            @endif</span></div>
                                                ...
                                                <div class="geodir-category-content fl-wrap">
                                                    ...
                                                    <div class="agent_card-title fl-wrap">
                                                        <h4><a >{{$agents->fname}}</a></h4>
                                                        <h5><a >Homey agency</a></h5>
                                                    </div>
                                                    <p class="para">{{$agents->description}}</p>
                                                  <!--   <div class="geodir-category-footer fl-wrap">
                                                        <a href="#" class="btn float-btn color-bg small-btn">View Profile</a>
                                                        <a href="mailto:{{$agentbasicinformation->username}}" class="tolt ftr-btn" data-microtip-position="left" data-tooltip="Write Message"><i class="fal fa-envelope"></i></a>
                                                        <a href="tel:{{$agentbasicinformation->phoneno}}" class="tolt ftr-btn" data-microtip-position="left" data-tooltip="Call Now"><i class="fal fa-phone"></i></a>	
                                                    </div> -->
                                                </div>
                                            </article>
                                        </div>
