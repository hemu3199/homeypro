                ...
                @if ($errors->any())
                    ...
                    <div class="container dasboard-container">
                        ...
                        <div class="dashboard-title fl-wrap">
                            <div class="dashboard-title-item"><span>Your Testimonials Listing</span></div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a class="tablebtn color-bg" style="background-color: red" href="{{ route('users-delete-testimonilas',$row->id) }}" role="button" aria-pressed="true"><i class='fas fa-trash-alt'></i></a>
                                                            </td>
                                                        </tr>
                                                        @empty
                                                        <tr>
